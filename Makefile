...
# Generated by qmake (2.01a) (Qt 4.8.2) on: ?? 7? 1 12:22:45 2012
# Project:  tmp.pro
# Template: app
# Command: /usr/bin/qmake -o Makefile tmp.pro
#############################################################################
...
Makefile: tmp.pro  /usr/share/qt4/mkspecs/linux-g++-64/qmake.conf /usr/share/qt4/mkspecs/common/unix.conf \
		/usr/share/qt4/mkspecs/common/linux.conf \
		/usr/share/qt4/mkspecs/common/gcc-base.conf \
		/usr/share/qt4/mkspecs/common/gcc-base-unix.conf \
		/usr/share/qt4/mkspecs/common/g++-base.conf \
...
dist: 
	@$(CHK_DIR_EXISTS) .tmp/tmp1.0.0 || $(MKDIR) .tmp/tmp1.0.0 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/tmp1.0.0/ && $(COPY_FILE) --parents generaloption.h imgfiledlg.h imgfilemodel.h loadformats.h mainwindow.h resizegrp.h .tmp/tmp1.0.0/ && $(COPY_FILE) --parents generaloption.cpp imgfiledlg.cpp imgfilemodel.cpp loadformats.cpp main.cpp mainwindow.cpp resizegrp.cpp .tmp/tmp1.0.0/ && (cd `dirname .tmp/tmp1.0.0` && $(TAR) tmp1.0.0.tar tmp1.0.0 && $(COMPRESS) tmp1.0.0.tar) && $(MOVE) `dirname .tmp/tmp1.0.0`/tmp1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/tmp1.0.0
